...
public class TutorialManager : MonoBehaviour
{
    ...
    private IEnumerator TutorialCoroutine()
    {
        ...
        screenText_5bis.text = "If the selected asset is out of range, you can <b>centre the camera</b> on it by selecting it again from the Assets Menu. ";   
        ...
        screenText_9.text = "Your next asset is an <b>MPA Aircraft</b>. It is much <b>faster</b> than the FREMM. You can select it from the Asset Menu just like the FREMM.";
        ...
        screenText_10.text = "<b>Move</b> both assets to their own <b>dedicated</b> area.";
        ...
        screenText_11.text = "Your objective is to <b>detect</b> submerged objects, then <b>identify</b> them to find the submarine. Finally, you'll have to <b>oblige the sub to abort her mission</b>.";
        opaquePanel.SetActive(true);
        ...
        screenText_20.text = "The submarine's goal is to <b>report intel on various points of interest</b>. To do this, he must stay close to the point he wishes to spy <b>for a few second</b>.";
