    ...
    public class Mad : Equipement
    {
        ...
        public override void UseEquipement(Coordinates userCoords)
        {
            ...
            foreach(DetectionObject obj in levelManager.activatedDetectionObjects)
            {
                ...
                if (distance <= range && obj.detectionState == DetectionState.unknownDetection) obj.detectionState = DetectionState.revealedDetection;
                else if (distance > range && obj.detectionState == DetectionState.revealedDetection) obj.detectionState = DetectionState.unknownDetection;
            }
        }
    }
}
